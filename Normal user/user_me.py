...
class User:
    ...
    def set_up_me_frame(self):
        def show_personal():
            ...
            cursor.execute('''SELECT * FROM patient p 
                           JOIN user u on u.user_id = p.patient_id
                           WHERE u.user_id=%s''', (self.user_id, ))
...
class Clinic:
    ...
    def set_up_appointment_frame(self):
        ...
        def display_appointments():
            ...
            query = f"""SELECT ar.ar_id, ar.ar_detail, ar.ar_date, ar.ar_time, ar.ar_status, d.doctor_id,
