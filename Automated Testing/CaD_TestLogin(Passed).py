...
class TestLogin(unittest.TestCase):
    ...
    def test_empty_email_and_password(self):
        ...
        self.mock_login_ui.l_validate_login_label.config.assert_called_with(text='Please fill in all the details')
    ...
    def test_invalid_email_format(self):
        ...
        # Verify the label's config method was called with the expected argument
        self.mock_login_ui.l_validate_login_label.config.assert_called_with(text='Invalid Email Format')
    ...
    def test_not_exist_email(self):
        ...
        # Set the mock cursor to return None, simulating the email not existing
        ...
        # Verify the label's config method was called with the expected argument
        self.mock_login_ui.l_validate_login_label.config.assert_called_with(text='Email does not exist')
    ...
    def test_incorrect_password(self):
        ...
        # Set the mock cursor to return a password that does not match
        ...
        # Verify the label's config method was called with the expected argument
        self.mock_login_ui.l_validate_login_label.config.assert_called_with(text='Incorrect Password')
    ...
    def test_success_login(self):
        ...
        # Set the mock cursor to return the correct password and user details
        ...
        # Verify the label's config method was called with the expected argument
        self.mock_login_ui.l_validate_login_label.config.assert_called_with(text='')
